            ...
            <form id="contact_form" onsubmit="return sendMail()">
                <div style="margin: 0 auto; text-align: left; position: relative; max-width: 610px;">
                    ...
                    <div style="text-align: left; width: 300px; display: inline-block; vertical-align: top;">
                        <div style="display: inline-block;"><img src="/admin/content/assets/captcha/securimage_show.php" alt="CAPTCHA Image" name="siimage" id="siimage" /><a tabindex="-1" style="border-style: none" href="#" title="Refresh Image" onclick="document.getElementById('siimage').src = 'content/assets/captcha/securimage_show.php?sid=' + Math.random(); return false"><br/><img src="content/assets/captcha/images/refresh.gif" alt="Reload Image" border="0" onclick="this.blur()" align="top" /><span class="style1">Reload Captcha</span></a></div><br/>
...
<script type="text/javascript">
    ...
    function sendMail(){
        ...
        var code = $("#code").val();
        var data = $.ajax({
            url: "content/assets/process_contact.php",
            type: "POST",
